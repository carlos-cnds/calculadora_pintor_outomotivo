  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      theme: ThemeData(
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(5),
            borderSide: const BorderSide(width: 2, color: Color(0xff111c80))
          )
        )
      ),
      initialRoute: '/home',
      getPages: [
        ...
        GetPage(name: '/formula', page: () => FormulaScreen(brand: Get.arguments['brand'], product: Get.arguments['product'],))
      ],
    );
  }
}
